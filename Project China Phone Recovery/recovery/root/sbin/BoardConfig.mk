...
TARGET_BOARD_PLATFORM := msm8909               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := SCL-L21     # From ro.product.board
...
TARGET_ARCH := armv7
TARGET_ARCH_VARIANT := armv7-v7i
TARGET_CPU_ABI := armeabi-v7a
TARGET_CPU_ABI2 :=armeabi
TARGET_CPU_VARIANT := qualcomm
TARGET_2ND_ARCH := armv7
TARGET_2ND_ARCH_VARIANT := armv7-v7i
TARGET_2ND_CPU_ABI := armeabi-v7a
TARGET_2ND_CPU_ABI2 := armeabi
TARGET_2ND_CPU_VARIANT := qualcomm
